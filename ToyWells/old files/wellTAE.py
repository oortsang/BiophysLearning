...
class VAE(nn.Module):
    def __init__(self):
        ...
        self.encode_layers_means = [nn.Linear(in_dim, hsize),
                                    nn.Tanh(),
                                    nn.Linear(hsize, hsize),
                                    nn.Tanh(),
                                    nn.Linear(hsize, n_z) # just linear combination
                                   ]
    ...
    def plot_test(self, plot = True, axes=(2,3), ret = False):
